"""
Django settings for TriplexDB project.
...
WSGI_APPLICATION = 'TriplexDB.wsgi.application'
...
DATABASES = {
    'default': {
	    ...
	    'NAME': '/home/triplexicon/triplex/TripLexicon_lncRNAs_Hs_updated_biotypes_alignments.db',
	    'HOST': '192.168.169.94',
        'PORT': '8000',
        'OPTIONS': {
            'timeout': 2000,  
    ...
    'mouse' : {
        'ENGINE': 'django.db.backends.sqlite3',
	    'NAME': '/home/triplexicon/triplex/TripLexicon_lncRNAs_Mm_updated_enhancers_biotype_alignment.db',
	    'HOST': '192.168.169.94',
        'PORT': '8000',
        'OPTIONS': {
            'timeout': 2000,
