function MultiSelectTag(
    ...
    function h(e=null){
        ...
        else{const n=document.createElement("li");
        ...
        function f(e){
            ...
            (t=>{d.find((t=>t.value==e.value)).selected=!1,g(e.value),h(),E()})),t.appendChild(n),t.appendChild(l),o.append(t)}
            function L(){
            ...
            function(){
                ...
                (l=document.createElement("div")).classList.add("mult-select-tag"), l.id=`${t.multiselect_id}`,
                ...
                (r=document.createElement("input")).classList.add("input"),r.placeholder=`${t.placeholder||"Search..."}`,r.id=`${t.id}`,
                ...
                t.rounded&&p.classList.add("rounded"),p.append(c),
                v=document.createElement("ul"), v.id=`${t.list_id}`,p.appendChild(v),
                l.appendChild(a),
                l.appendChild(p),
            ...
            r.addEventListener("keydown",(e=>{if("Backspace"===e.key&&!e.target.value&&o.childElementCount>1){
                const e=i.children[o.childElementCount-2].firstChild;d.find((t=>t.value==e.dataset.value)).selected=!1,g(e.dataset.value),E()}})),
